      ...
      <div className="flex-1 overflow-y-auto no-scrollbar px-6 space-y-8 pb-10">
        ...
        <div className="px-2 pt-8 pb-4 border-t border-slate-100 flex flex-col gap-3">
           <div className="flex items-center gap-3">
             ...
             <span className="text-[8px] font-black text-slate-200 uppercase tracking-[0.5em] font-mono">Infrastructure</span>
             <div className="flex-1 h-px bg-slate-100" />
           </div>
           <p className="text-[8px] text-center text-slate-200 font-bold leading-relaxed px-4 opacity-50">
