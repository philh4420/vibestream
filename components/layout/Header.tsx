...
import { UserRole, Region, User as VibeUser } from '../../types';
          ...
          <div className="hidden sm:flex items-center gap-3 pl-4 border-l border-slate-200">
            <div className="flex flex-col items-end">
              <div className="flex items-center gap-2">
                <span className="text-sm font-black text-slate-900 tracking-tight">{userData?.displayName || 'Syncing...'}</span>
                {userData?.role === 'creator' || userData?.role === 'admin' ? <ICONS.Verified /> : null}
              </div>
