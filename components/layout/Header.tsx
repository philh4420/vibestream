  ...
  const handleNotifClick = (n: AppNotification) => {
    ...
    if (n.type === 'message') {
        ...
        if (n.type === 'follow') {
            ...
            // Assume it's a post interaction
      ...
      <div className="flex items-center justify-between w-full max-w-[2560px] mx-auto h-full px-4 md:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative" ref={menuRef}>
            ...
            {isSystemMenuOpen && (
              <div className="absolute right-0 top-full mt-4 w-64 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[2rem] shadow-heavy p-4 z-[1100] animate-in zoom-in-95 duration-200">
