      ...
      <div className="absolute top-4 left-4 right-4 z-20">
        <div className="bg-white/80 backdrop-blur-xl border border-white/50 rounded-[2rem] p-3 shadow-sm flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 pr-1">
             <button onClick={() => handleCall('voice')} className="w-10 h-10 bg-slate-50 text-slate-300 rounded-2xl flex items-center justify-center transition-all cursor-not-allowed opacity-60">
             ...
             <button onClick={() => handleCall('video')} className="w-10 h-10 bg-slate-50 text-slate-300 rounded-2xl flex items-center justify-center transition-all cursor-not-allowed opacity-60">
