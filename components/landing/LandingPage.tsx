...
export const LandingPage: React.FC<LandingPageProps> = ({ onEnter }) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] bg-[#020617] text-white flex flex-col lg:flex-row font-outfit overflow-hidden selection:bg-indigo-500">
      ...
      <section className={`relative z-10 flex-1 flex flex-col p-8 md:p-16 lg:p-24 justify-between transition-all duration-1000 ${step !== 'discovery' ? 'lg:opacity-40 lg:blur-sm' : 'opacity-100'}`}>
        <header className="flex items-center gap-6 animate-in fade-in slide-in-from-top-8 duration-700">
        ...
        <div className="max-w-4xl animate-in fade-in slide-in-from-left-12 duration-1000 delay-300">
      ...
      <section className="relative z-20 w-full lg:w-[45vw] 2xl:w-[35vw] bg-white/[0.02] lg:bg-white/[0.03] backdrop-blur-[120px] lg:border-l border-white/10 flex flex-col justify-center p-6 md:p-12 lg:p-20 overflow-y-auto">
          ...
          <div className="animate-in fade-in zoom-in-95 duration-500">
            ...
            <div className="relative group">
              ...
              <button 
                ...
                className={`relative w-full aspect-square md:aspect-auto md:h-64 rounded-[3rem] border-2 transition-all duration-300 flex flex-col items-center justify-center gap-6 overflow-hidden select-none touch-none ${isVerified ? 'bg-emerald-500 border-emerald-400 scale-95' : 'bg-white/5 border-white/10 hover:bg-white/10'}`}
              >
                <div 
        ...
        {step === 'entry' && (
          <div className="animate-in slide-in-from-right-12 duration-700">
            <div className="flex gap-10 mb-16 justify-center lg:justify-start">
            ...
            <form onSubmit={handleEntry} className="space-y-6 md:space-y-8">
              {authMode === 'register' && (
              ...
              <p className="text-center text-slate-500 text-xs font-bold uppercase tracking-widest leading-loose mt-8">
