...
export const DeleteConfirmationModal: React.FC<DeleteConfirmationModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[3000] flex items-center justify-center p-6 animate-in fade-in duration-300">
      <div className="absolute inset-0 bg-slate-950/90 backdrop-blur-2xl" onClick={onCancel}></div>
      ...
      <div className="relative bg-white w-full max-w-sm rounded-[3.5rem] p-10 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.5)] border border-white/10 overflow-hidden animate-in zoom-in-95 duration-500">
        ...
        <div className="text-center space-y-6 mb-10">
          <div className="w-20 h-20 bg-rose-50 text-rose-600 rounded-[2rem] flex items-center justify-center mx-auto shadow-sm relative">
            <div className="absolute inset-0 rounded-[2rem] bg-rose-500 animate-ping opacity-20" />
          ...
          <div>
            <h3 className="text-2xl font-black text-slate-950 tracking-tighter uppercase italic leading-none mb-3">PROTOCOL_ALERT</h3>
        ...
        <div className="flex flex-col gap-3">
          <button 
            ...
            className="w-full py-6 bg-rose-600 text-white rounded-[1.8rem] font-black text-[10px] uppercase tracking-[0.4em] shadow-2xl shadow-rose-900/20 hover:bg-rose-700 transition-all active:scale-95 italic"
          >
            {confirmText}
          </button>
          ...
          <button 
            ...
            className="w-full py-5 bg-slate-50 text-slate-400 rounded-[1.8rem] font-black text-[10px] uppercase tracking-[0.4em] hover:bg-slate-100 transition-all active:scale-95 italic"
          >
            ABORT_ACTION
          </button>
        </div>
        ...
        <div className="mt-8 text-center opacity-20">
          <p className="text-[8px] font-black text-slate-950 uppercase tracking-[0.5em] font-mono italic">TERMINATION_VERIFICATION_REQUIRED</p>
        </div>
      </div>
    </div>
  );
