...
export const SimulationsPage: React.FC = () => {
  return (
    <div className="w-full h-full flex flex-col items-center justify-center p-4 md:p-6 animate-in fade-in duration-700 relative overflow-hidden min-h-[80vh]">
      ...
      <div className="relative z-10 max-w-3xl w-full bg-white/60 backdrop-blur-3xl border border-white/60 shadow-[0_40px_100px_-30px_rgba(0,0,0,0.1)] rounded-[3.5rem] p-8 md:p-16 text-center overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-10">
           <div className="w-28 h-28 bg-slate-950 rounded-[2.5rem] flex items-center justify-center mb-8 shadow-2xl relative group border border-white/10">
           ...
           <h1 className="text-5xl md:text-7xl font-black text-slate-900 tracking-tighter uppercase italic leading-none mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12 max-w-2xl mx-auto">
           {[
             ...
             <div key={idx} className="p-4 rounded-[2rem] bg-white border border-slate-100 shadow-sm flex flex-col items-center gap-3 opacity-60 grayscale hover:grayscale-0 hover:opacity-100 transition-all cursor-default">
                ...
                <span className="text-[9px] font-black uppercase tracking-widest text-slate-400 font-mono">{item.label}</span>
             </div>
           ))}
        </div>
