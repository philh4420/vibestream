...
export const VerifiedNodesPage: React.FC<VerifiedNodesPageProps> = ({ users, onViewProfile, onFollow }) => {
           ...
           <div key={user.id} className="group bg-white border border-slate-100 rounded-[3rem] p-8 hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] transition-all duration-500 relative overflow-hidden">
              ...
              <div className="flex items-center gap-3">
                 <button 
                   ...
                   className="flex-1 py-4 bg-slate-50 hover:bg-slate-950 hover:text-white text-slate-900 rounded-2xl font-black text-[9px] uppercase tracking-[0.2em] transition-all shadow-sm active:scale-95"
                 >
                   Establish_Link
                 </button>
