...
export const AdminPanel: React.FC<AdminPanelProps> = ({ addToast, locale, systemSettings, userData }) => {
  ...
  return (
    <div className="flex flex-col w-full max-w-[2400px] mx-auto min-h-full pb-24 text-slate-900 dark:text-white">
      ...
      <div className="sticky top-0 z-40 pt-2 pb-6 bg-gradient-to-b from-[#fcfcfd] via-[#fcfcfd]/95 to-transparent dark:from-slate-950 dark:via-slate-950/95 backdrop-blur-sm -mx-4 px-4 md:mx-0 md:px-0">
        <AdminHeader 
          activeTab={activeTab} 
