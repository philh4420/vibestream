    ...
    <div className="mt-8 pt-8 border-t border-slate-100 dark:border-slate-800 animate-in slide-in-from-bottom-2 duration-500">
      ...
      <form onSubmit={handleSubmitComment} className="flex flex-col gap-4 mb-8 bg-slate-50 dark:bg-slate-900/50 p-4 rounded-[2rem] border border-slate-100 dark:border-slate-800 relative group/input focus-within:border-indigo-200 dark:focus-within:border-indigo-800 focus-within:ring-4 focus-within:ring-indigo-500/5 transition-all">
        ...
        <div className="flex items-end gap-3">
          <img src={userData?.avatarUrl} className="w-10 h-10 rounded-xl object-cover shrink-0 shadow-sm border border-white dark:border-slate-700" alt="" />
          ...
          <div className="flex-1 flex flex-col gap-2">
             <input 
               ...
               className="w-full bg-transparent border-none p-0 text-sm font-bold text-slate-900 dark:text-white outline-none placeholder:text-slate-300 dark:placeholder:text-slate-600 h-10"
             />
             ...
             <div className="flex items-center gap-1">
               <button 
                 ...
                 className={`p-2 rounded-lg transition-all active:scale-90 ${selectedFile ? 'text-indigo-600 dark:text-indigo-400 bg-indigo-100 dark:bg-indigo-900/30' : 'text-slate-400 dark:text-slate-500 hover:text-indigo-500 dark:hover:text-indigo-400 hover:bg-white dark:hover:bg-slate-800'}`}
               >
               ...
               <button 
                 ...
                 className={`p-2 rounded-lg transition-all active:scale-90 ${isGiphyPickerOpen ? 'text-indigo-600 dark:text-indigo-400 bg-indigo-100 dark:bg-indigo-900/30' : 'text-slate-400 dark:text-slate-500 hover:text-indigo-500 dark:hover:text-indigo-400 hover:bg-white dark:hover:bg-slate-800'}`}
               >
               ...
               <button 
                 ...
                 className={`p-2 rounded-lg transition-all active:scale-90 ${isEmojiPickerOpen ? 'text-indigo-600 dark:text-indigo-400 bg-indigo-100 dark:bg-indigo-900/30' : 'text-slate-400 dark:text-slate-500 hover:text-indigo-500 dark:hover:text-indigo-400 hover:bg-white dark:hover:bg-slate-800'}`}
               >
          ...
          <button 
            ...
            className="p-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-xl shadow-lg hover:bg-indigo-600 dark:hover:bg-indigo-400 transition-all active:scale-95 disabled:opacity-30 disabled:bg-slate-300 dark:disabled:bg-slate-700 shrink-0"
          >
             {isSubmittingComment ? (
      ...
      <div className="space-y-6">
        {commentThreads.root.length > 0 ? (
          ...
          <div className="py-12 text-center opacity-40 bg-slate-50/50 dark:bg-slate-800/30 rounded-[2rem] border border-dashed border-slate-200 dark:border-slate-700">
            <p className="text-[10px] font-black uppercase tracking-[0.3em] font-mono italic text-slate-400 dark:text-slate-500">Signal_Path_Clear</p>
            <p className="text-[8px] font-bold text-slate-300 dark:text-slate-600 mt-1 uppercase tracking-widest">Be the first to echo.</p>
          </div>
        )}
      </div>
    </div>
